...
const extraTechIconMap: Record<string, TechIconMeta> = {
  ...
  redis: { key: "redis", label: "Redis", icon: "https://htmacgfeigx1pttr.public.blob.vercel-storage.com/icon/redis.svg" },
  ...
  "oauth 2.0": { key: "oauth 2.0", label: "OAuth 2.0", icon: "https://htmacgfeigx1pttr.public.blob.vercel-storage.com/Oauth_logo.png" },
  "oauth 2.1": { key: "oauth 2.1", label: "OAuth 2.1", icon: "https://htmacgfeigx1pttr.public.blob.vercel-storage.com/Oauth_logo.png" },
