...
const MINIMAP_SCALE_MULTIPLIER = 0.5;
      ...
      {isModalOpen && (
        <div className="mermaid-modal-overlay fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-3 py-4" onClick={closeModal}>
          <div
            ...
            className="mermaid-modal relative flex h-[96vh] w-[96vw] max-w-none flex-col overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--card)] shadow-2xl"
