...
정리하면, 이 프로젝트의 데이터 구조는 ERP 전체를 완성도 높게 분해한 결과라기보다, bounded context와 조회 계약, 초기화 데이터 기준을 먼저 안정시키고 팀이 같은 업무 언어와 같은 기준으로 개발할 수 있게 하기 위한 현실적인 경계 정리에 더 가까웠습니다.
